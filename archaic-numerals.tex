...
The photos in \textsc{cdli} clearly show that this is in fact a vertical wedge.}
...
but a cursory search in \textsc{cdli} finds many occurrences\footnote{A search for
...
In all cases the transcriptions given here are based on the Eb\textsc{da} transliterations, but the
shape and orientation of the numerals was checked\footnotemark on a photograph (from Eb\textsc{da} unless noted otherwise).}:
\footnotetext{As we will see in
Section~\ref{transliteration}, \textsc{cdli} transliterations indicate numeral shape; however,
...
\begin{enumerate}[nosep]
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1383\#62337}{\recto~2, 6}]{P240654} {\curviform\oneAšC\xsuxfont 𒁀𒌷𒍪 𒐋𒋡\footnote{Instead of the expected {\xsuxfont 𒃻𒌋𒊕}.} 𒐈𒀭𒍡\footnote{{\xsuxfont 𒐈𒀭𒍡} not legible on the Eb\textsc{da} photo.}}% 1 ba-ri₂-zu 6 sila₃ 3 an-zamᵪ % ARET 09 0069
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/3173\#154945}{\recto~1, 1}]{P241708}\footnote{From \textsc{cdli} photo.} {\curviform\twoAšC\oneDišC\xsuxfont 𒆗 𒄘𒁇 𒐌𒃻𒌋𒊕}% 2 1/2 sig₁₅ gu₂-bar 7 nig₂-sagšu  EST 50 https://cdli.mpiwg-berlin.mpg.de/artifacts/241708/reader/133004
