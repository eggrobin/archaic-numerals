...
In contrast, the cuneiform encoding model requires that the language
of a text be understood to correctly encode it.
...
or well-attested in proto-Elamite texts but insufficiently attested in Uruk---those are discussed in §\ref{proposal}.
