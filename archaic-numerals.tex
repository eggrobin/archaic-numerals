...
\begin{itemize}[nosep]
  ...
  \begin{itemize}
    ...
    \item in the same word with a determinative, {\xsuxfont 𒀸𒄩} dili\textsuperscript{ku}\textsuperscript*{₆},
...
\cite[58]{Catagnoti2010} has the numeric signs {\curviform \oneAšC}, {\xsuxfont 𒀹}, {\xsuxfont 𒁹},
whereas non-numeric {\xsuxfont 𒀸} is at the beginning of the sign list given with its values \emph{aš} and \emph{rum};
\cite{Deimel1922} starts with {\xsuxfont 𒀸} TODO
...
the lack of Early Dynastic fonts, by the aforementioned issues with numeral identification
