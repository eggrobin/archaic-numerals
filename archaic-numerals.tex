...
[TODO(egg):Eblaite capacities \cite{P240964} TODO(egg): There are ŋeš₂ gubar]
\begin{equation}
  \underbrace{
  \text{\curviform \oneAšC\xsuxfont 𒇷}
  \xleftarrow{10}\text{\curviform \oneAšC\xsuxfont 𒈪}
  \xleftarrow{10}\text{\curviform \oneUC}
  \xleftarrow{10}\text{\curviform\oneDišC}}_{\text{\xsuxfont 𒄘𒁇}}
  \xleftarrow{10}\text{\xsuxfont 𒁹𒋙𒃻}
