...
(round) end of the stylus.'' [TODO(egg): also mention Krebernick 1998 p. 303 with note 686.]
...
Because of their prevalence in the Early Dynastic period,
the proposed numerals are used modern publications discussing Metrology
from that period, as illustrated in Figures \ref{englund113}--\ref{GoriTransliteration}.
...
\begin{figure}
  \begin{center}
  \includegraphics[width=0.75\textwidth]{krebernick-303.png}
...
\begin{figure}
  ...
  \end{center}
\end{figure}
\footnotetext{TODO(egg): On the order cite TSS 188, Friberg2007 p. 148 and any of the usual suspects on the haphazard order of signs in early texts.}
\begin{figure}
  \begin{center}
...
\begin{figure}
  ...
  \caption{Transliteration in \cite[163]{Gori2023} of \cite[\href{https://ebda.cnr.it/tablet/view/217\#13705}{\recto~4, 1}]{P242293} incorporating untransliterated numerals.\label{GoriTransliteration}}
  \end{center}
\end{figure}
