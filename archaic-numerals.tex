...
These\footnote{TODO Cite also DP 568, the one with {\curviform \oneŊešTwoC} and {\curviform\oneAšC}{\xsuxfont 𒂠} even though it has no reeds.} match the following factor diagram:
\begin{equation}
  \underbrace{
...
indicating that the GUR numerals are curviform (with the parenthetical
GUR indicating that these are {\curviform\oneAšC} rather than {\curviform\oneDišC} numerals).

\subsection{Conclusions}
TODO words
Mention something about potential for confusion in character identity.
