...
\begin{itemize}
  ...
  \item Clarified the descriptions of the Script and Script\_Extensions property assignments in the summary.
  ...
  and U+\textcsc{1245E} \smash{\cuneiformComposite 𒑞} \textcsc{CUNEIFORM NUMERIC SIGN TWO THIRDS\strikeThrough{ DISH} VARIANT FORM A} in names list cross references.
\end{itemize}
