...
\newcommand\oneNSixty{{\proposalfont\symbol{"125E0}}}
...
\label{systemŠprime}
\end{equation}
The highest attested number in this system is \oneNFortyFiveA\twoNEighteen\twoNThree\fourNForty{}, in \cite{P005363}.
The numerals \oneNFortyFiveA{} $N_{45a}$ is not included in \cite[165\psq]{DamerowEnglund1987}, and the numeral
\oneNTwentyFourA{} $N_{24a}$ appears there only as a reconstruction in brackets, without a name;
but both appear in \cites[29]{NissenDamerowEnglund1993}[33]{Englund2004} with the names $N_{45'}$ and $N_{24'}$,
and are listed in \cite{archsigns} with their ATF names \texttt{N45~a} and \texttt{N24~a}.
They are attested in CDLI transliterations.
