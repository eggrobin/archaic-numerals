...
the following capacity from \cite[\href{http://oracc.org/epsd2/P309594.3}{\obverse~1}]{P309594}:
\[\begin{matrix}
\text{\xsuxfont 𒐢𒐝𒌋𒐂}&
\text{\xsuxfont 𒑑}&
\text{\xsuxfont 𒐋}&
...
A more comprehensive overview of numeral usage in Eblaite capacity measures systems may be found in
\cite[141--144]{Gori2024}; exceptions exist, with {\xsuxfont 𒃻𒋙𒊕} occasionally counted in {\oneDišC} or
{\oneAšC} numerals. Note that the example cited for \oneAšC{} numerals, namely
\cite[\href{http://ebda.cnr.it/tablet/view/1324\#57956}{\recto~1~7}]{P240532} {\xsuxfont\fourAšC 𒃻𒋙𒊕},
is an expression without any of the higher units; on the same tablet,
\cite[\href{http://ebda.cnr.it/tablet/view/1324\#58045}{\verso~4~9}]{P240532} (item~\ref{P240532-v-4-9}) which combines
{\xsuxfont 𒁀𒌷𒅗} and {\xsuxfont 𒃻𒋙𒊕} in a single expression uses {\xsuxfont 𒁹} numerals for
the {\xsuxfont 𒃻𒋙𒊕}. \cite{Gori2024} does not mention the use of anything other than
{\xsuxfont 𒁹} numerals for {\xsuxfont 𒀭𒍡},
nor any cuneiform numerals for integer {\xsuxfont 𒄘𒁇}.}.
