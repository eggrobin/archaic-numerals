...
\newcommand\fourDišC{\symbol{"E5A2}}

\newcommand\oneŠarTwoC{{\originalNoto 𒊹}}
...
% \begin{itemize}[nosep]
%   \item U+\textcsc{12550}--U+\textcsc{12558} {\curviform\oneAšC}--{\curviform\nineAšC} \textcsc{CUNEIFORM NUMERIC SIGN ONE N01--CUNEIFORM NUMERIC SIGN NINE N01}
%   \item U+\textcsc{1257D}--U+\textcsc{12585} {\curviform\oneDišC}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N08--CUNEIFORM NUMERIC SIGN NINE N08}
%   \item U+\textcsc{1258B}--U+\textcsc{12583} {\curviform\oneUC}--{\curviform\nineUC} \textcsc{CUNEIFORM NUMERIC SIGN ONE N14}--\textcsc{CUNEIFORM NUMERIC SIGN NINE N14}
%   \item U+\textcsc{12559}--U+\textcsc{12561} {TODO}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N02--CUNEIFORM NUMERIC SIGN NINE N02}
%   \item U+\textcsc{12562}--U+\textcsc{12566} {TODO}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N03--CUNEIFORM NUMERIC SIGN FIVE N03}
%   \item U+\textcsc{12568}--U+\textcsc{1256B} {TODO}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N04--CUNEIFORM NUMERIC SIGN FIVE N04}
%   \item U+\textcsc{1256C}--U+\textcsc{12570} {TODO}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N05--CUNEIFORM NUMERIC SIGN FIVE N05}
%   \item U+\textcsc{12571}--U+\textcsc{12579} {TODO}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N06--CUNEIFORM NUMERIC SIGN NINE N06}
%   \item U+\textcsc{1257A}--U+\textcsc{1257C} {TODO}--{TODO} \textcsc{CUNEIFORM NUMERIC SIGN ONE N07--CUNEIFORM NUMERIC SIGN THREE N07}
%   \item U+\textcsc{12586} {TODO} \textcsc{CUNEIFORM NUMERIC SIGN N09}
%   \item U+\textcsc{12587} {TODO} \textcsc{CUNEIFORM NUMERIC SIGN N10}
%   \item U+\textcsc{12589} {TODO} \textcsc{CUNEIFORM NUMERIC SIGN N11}
%   \item U+\textcsc{1258A} {TODO} \textcsc{CUNEIFORM NUMERIC SIGN N12}
% \end{itemize}
...
later in the third millenium\footnote{Merging with U+\textcsc{1224E} {\xsuxfont 𒉎} NI₂.},
...
\end{tabular}
\end{flushright}
\footnotetext{Transliteration after \cite[325]{Lecompte2020}.}
\end{quote}
...
\begin{equation}
  ...
  \label{systemLED}
\end{equation}
\footnotetext{Note that the reeds are counted using \emph{tenû} numerals, {\xsuxfont 𒀹}, {\xsuxfont 𒑊}, {\xsuxfont 𒑋}, etc.}
...
(round) end of the stylus.'' [TODO(egg): also mention Krebernik 1998 p. 303 with note 686.]
...
\begin{itemize}[nosep] % TODO(egg): Check the photos while adding them to the bibliography.
  ...
  indeed another {\xsuxfont 𒋗𒆕𒀀𒑊} can be seen both on the copy and the photo on \obverse~2, 2.} {\curviform\twoAšC\xsuxfont 𒂠𒑍𒄀𒌑𒑌𒋗𒆕𒀀𒑊}% 2(asz@c) esz2 5(disz@t) gi kusz3 4(disz@t) szu-du3-a 2(disz@t)
%  \item \cite[\reverse~1, 1]{P221305} {\curviform\oneŊešTwoC\fourUC\oneBanTwoC\xsuxfont 𒂠𒑍𒄀} % 1(gesz2@c) 4(u@c) 1/2(asz@c) esz2 5(disz@t) gi
  ...
  \item \cite[\reverse~5, 1]{P221291}\footnote{From copy.} {\curviform\oneŊešʾuC\twoŊešTwoC\fourUC\oneBanTwoC\xsuxfont 𒂠𒃻𒁺𒑊𒄀𒌑𒑋} % 1(gesz'u@c) 2(gesz2@c) 4(u@c) 1/2(asz@c) esz2 {ninda}nindax(DU) 2(disz@t) gi kusz3 3(disz@t)
...
These\footnote{TODO Cite also DP 568, the one with {\curviform \oneŊešTwoC} and {\curviform\oneAšC}{\xsuxfont 𒂠} even though it has no reeds.}
...
\begin{equation}
  ...
  \xleftarrow{2}\text{\curviform \oneBanTwoC}}_{\text{\xsuxfont 𒂠\footnotemark}}
...
\begin{enumerate}[nosep]
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1324\#58045}{\verso~4, 9}]{P240532} {\curviform\oneAšC\xsuxfont 𒊺 𒁀𒊑𒅗\footnote{ba-ri₂-zu₂, a variant spelling.}𒐊𒃻𒋙𒊕}% v.4,9 1 še ba-ri₂-zu₂ 5 nig₂-sagšu % ARET 09 0010 
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1358\#60317}{\recto~7, 9}]{P240655} {\curviform\twoAšC\xsuxfont 𒊺𒁇\footnote{Short for {\xsuxfont 𒄘𒁇}.}𒐊𒃻𒋙𒊕} % r.7,9	2 še bar 5 nig₂-sagšu ARET 09 0044
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1364\#60805}{\verso~4, 3}]{P240579} {\curviform\fiveAšC\oneDišC\xsuxfont 𒄘𒁇 𒈫𒃻𒋙𒊕}% 5-1/2 gu₂-bar 2 nig₂-sagšu ARET 09 0050
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1371\#61227}{\verso~2, 2}]{P240675} {\curviform\oneAšC\xsuxfont 𒊺 𒁀𒌷𒍪 𒐊𒃻𒋙𒊕}% v.2,2  1 še ba-ri₂-zu 5 nig₂-sagšu ARET 09 0057
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1379\#61615}{\recto~3, 3}]{P240533} {\curviform\twoUC\oneAšC\oneDišC\xsuxfont 𒄘𒁇 𒐌𒃻𒋙𒊕 𒈫𒈦𒀭𒍡𒍝}  % ARET 09 0065 #61615 20-1-1/2 gu₂-bar 7 nig₂-sagšu 2-1/2 an-zamᵪ za
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1382\#62088}{\recto~6, 2}]{P240653} {\curviform\twoUC\threeAšC\oneDišC\xsuxfont 𒄘𒁇\curviform\xsuxfont 𒁹𒃻𒋙𒊕 𒈫𒈦𒀭𒍡} % ARET 09 0068  20-3-1/2 gu₂-bar 1 nig₂-sagšu 2-1/2 an-zamᵪ  (also has 1 ba-ri₂-zu₂ 1 GIN₂ elsewhere)
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1383\#62337}{\recto~2, 6}]{P240654} {\curviform\oneAšC\xsuxfont 𒁀𒌷𒍪 𒐋𒋡\footnote{Instead of the expected {\xsuxfont 𒃻𒋙𒊕}.} 𒐈𒀭𒍡\footnote{{\xsuxfont 𒐈𒀭𒍡} not legible on the EbDA photo.}}% 1 ba-ri₂-zu 6 sila₃ 3 an-zamᵪ % ARET 09 0069
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1415\#63792}{\recto~1, 8}]{P240531} {\curviform\oneAšC\xsuxfont 𒁀𒌷𒍪 𒐋𒃻𒋙𒊕 𒊺𒍥𒄖}% r.1,8	1 ba-ri₂-zu 6 nig₂-sagšu še-zid₂-gu ARET 09 101 
  \item \cite[\href{http://ebda.cnr.it/tablet/view/3173\#154945}{\recto~1, 1}]{P241708}\footnote{From CDLI photo.} {\curviform\twoAšC\oneDišC\xsuxfont 𒆗 𒄘𒁇 𒐌𒃻𒋙𒊕}% 2 1/2 sig₁₅ gu₂-bar 7 nig₂-sagšu  EST 50 https://cdli.mpiwg-berlin.mpg.de/artifacts/241708/reader/133004
  \item \cite[\href{http://ebda.cnr.it/tablet/view/3183\#155340}{\recto~1, 1}]{P241904}\footnote{From photo in \cite[6]{Archi1989}.} {\curviform\fourAšC\xsuxfont 𒄘𒁇 𒐉\footnote{Laid out as {\xsuxfont 𒁹𒁹𒁹𒁹}; on stacking patterns see Section~\ref{stackingPatterns}.}𒃻𒋙𒊕}% EST 60 = RA 083, 001, fig. 1
\end{enumerate}
...
\begin{tikzcd}[column sep=small]
  \smash{\underbrace{\text{\curviform \oneAšC\xsuxfont 𒈪𒀜}
  \xleftarrow{\frac{5}{3}}\text{\curviform \oneŊešTwoC}
  \xleftarrow{6}\text{\curviform \oneUC}
...
the proposed numerals are used modern publications discussing metrology
in those periods, as illustrated in Figures \ref{englund113}--\ref{GoriTransliteration}.
...
The partial\footnote{The untransliterated text would be {\curviform \fourAšC\xsuxfont 𒂍𒁕𒌝𒌆𒑊\curviform\fourDišC\xsuxfont 𒀀𒋢\curviform \fourAšC\xsuxfont 𒔻𒌆𒊷𒁯}; note the atomically encoded $\text{ib₂}\times3\text{\xsuxfont 𒁹}=\text{\xsuxfont 𒌈}\times\text{\xsuxfont 𒐈}=\text{\xsuxfont 𒔻}$.} transliteration ``$4\text{\curviform \oneAšC}$
\emph{ʾa₃-da-um} $4\text{\curviform\oneDišC}$ \emph{aktum}
$4\text{\curviform \oneAšC}$
ib₂\textsuperscript*{tu₉}×$3\text{\xsuxfont 𒁹}$ sa₆ gunu₃''
is used to illustrate a discussion of the interpretation of
the contrast between {\curviform \oneAšC} and {\curviform \oneDišC} numerals.
...
\begin{figure}
  \begin{center}
  TODO figure
  \caption{TODO \cite[6]{Chambon2016}\label{chambon6}}
  \end{center}
\end{figure}
...
\begin{figure}
  ...
  \caption{Discussion of the contrast between {\curviform \oneAšC} and {\curviform \oneDišC} numerals in \cite[162]{Gori2023}.\label{gori162}}
  \end{center}
\end{figure}
...
however, these signs have merged by the Old Babylonian period when the first witnesses of
Examenstext A are attested.}
...
While the horizontal numerals are most frequently written
written {\curviform\oneAšC} in the Early Dynastic period\footnote{A
...
\begin{itemize}[nosep]
  ...
  such as the following, which all contain {\curviform\oneAšC} numerals:\begin{itemize}[nosep]
  \item {\xsuxfont 𒀸𒊕} in
  ...
  \item {\xsuxfont 𒀸𒁯𒌦𒄷} in \cite[\obverse~7, 18]{P010964} from ED IIIa Šuruppag,
  ...
  \item in the Sumerian word {\xsuxfont 𒌑𒀸} u₂-rum, ``property'' in ED IIIb Ŋirsu administrative texts which contain
    {\curviform\oneAšC} numerals, such as
  ...
  \begin{itemize}[nosep]
    \item in the divine name {\xsuxfont 𒀭𒎏𒉾𒀸𒁇} in the lexical texts \cites[TODO]{P010570}[\obverse~3, 6]{P010572},
      where the entries are prefixed with {\curviform\oneAšC}.
    ...
    witness to Early Dynastic Food, which starts with {\curviform\oneAšC} numerals.
  \end{itemize}
\end{itemize}

This is a clear contrast between {\xsuxfont 𒀸} and {\curviform\oneAšC} in this period,
...
a line {\curviform\oneAšC\xsuxfont 𒊕} would instead be read as ``one slave''.
...
\cite[58]{Catagnoti2013} has the numeric signs {\curviform \oneAšC}, {\xsuxfont 𒀹}, {\xsuxfont 𒁹},
...
{\curviform \oneAšC}, {\xsuxfont 𒀹}, and {\xsuxfont 𒁹}.
...
For numerals, the switch from {\curviform \oneAšC} to {\xsuxfont 𒁹} numerals prevents
diachronic encoding even if {\curviform \oneAšC} were unified with {\xsuxfont 𒀸}.
...
{\curviform \oneAšC} numerals in the Early Dynastic witnesses; since {\xsuxfont 𒁹}
...
characters, the {\curviform \oneAšC}-{\xsuxfont 𒀸} unification does not help. 
...
compatibility issue.
Fortunately, with one exception discussed below,
...
In most texts from the Early Dynastic IIIb and Old Akkadian period\footnote{For example, in personal names:\begin{itemize}
...
similar to the contrast between {\xsuxfont 𒀸} and {\curviform \oneAšC}
...
non-numeric šar₂ is curviform:\begin{itemize}[nosep]
  ...
  \item {\originalNoto 𒊹𒄷} \cite[\href{https://oracc.museum.upenn.edu/dcclt/P240986.44}{\obverse~3, 3}]{P240986};
...
in those cases, with its curviform glyph {\cuneiformComposite 𒊹},
identical to the glyph of (TODO: the proposed character).
...
so these characters can have the same glyph.
...
between reference glyphs remains clear; see
...
non-numeric {\xsuxfont 𒀸} (here with the value rum) is written {\curviform\oneAšC}.
It is out of scope for this proposal to decide whether
such occurrences should be treated as anomalous spellings and encoded as
(TODO: the proposed characters) or as stylistic distinctions and encoded as
...
the CDLI transliteration (\texttt{UR2-1(aš@c)}) and the ePSD2 one (uru₈\textsuperscript*{rum})
...
the aforementioned {\curviform\twoUC\oneAšC\oneDišC\xsuxfont 𒄘𒁇 𒐌𒃻𒋙𒊕 𒈫𒈦𒀭𒍡𒍝}
...
{\curviform \oneDišC} and {\xsuxfont 𒈦} as $1/2$,
...
{\curviform\oneAšC} and {\curviform\oneDišC} numerals.
For instance, the aforementioned
{\curviform \fourAšC~\xsuxfont 𒂍𒁕𒌝𒌆𒑊 \curviform\fourDišC~\xsuxfont 𒀀𒋢 \curviform\fourAšC~\xsuxfont 𒔻
𒌆 𒊷𒁯}
...
in EbDA, with no distinction between the {\curviform \fourAšC} and {\curviform\fourDišC}.
...
in transliteration; for instance, {\xsuxfont 𒑘𒐃𒀹𒃷𒑂𒊬} from \cite[\obverse~1]{P386847}
is transliterated ``$1$(eše₃) $5\text{½}$~iku\footnote{TODO say something about this reading} $7$~sar'' in \volcite{2}[176]{Feuerherm2004},
and {\xsuxfont 𒑗𒑐𒑂𒈦𒋡} from \cite[\obverse~12]{P307255}
...
``$1$(esze3) $5$(iku) $1/2$(iku) GAN2 $7$(disz) sar'' for {\xsuxfont 𒑘𒐃𒀹𒃷𒑂𒊬},
and ``$3$(barig) $2$(ban2) $7$(disz) $1/2$(disz) sila3'' for {\xsuxfont 𒑗𒑐𒑂𒈦𒋡}.
CDLI and ePSD2 both distinguish curviform from cuneiform numerals in
transliteration: the length
{\curviform\sixŊešTwoC\threeUC\xsuxfont 𒃻𒁺\curviform\oneBanTwoC\xsuxfont 𒑌𒄀}
...
$1d$ for {\xsuxfont 𒁹}, $1ac$ for {\curviform \oneAšC}, $1dc$ or $\text{½}dc$ for {\curviform \oneDišC}
...
but not {\curviform \fourAšC} from {\xsuxfont 𒀸}, such as the ones used in \cite{DCCMT},
...
{\curviform\oneUC\fiveAšC\xsuxfont 𒑖𒑏}, with a c
indicating that the GUR numerals are curviform, and the parenthetical
GUR indicating that these are {\curviform\oneAšC} rather than {\curviform\oneDišC} numerals.

\subsection{Conclusions}
Co-occurences of curviform and cuneiform numerals are not anecdotal
in the Early Dynastic period.
Instead, they represent contrasts between metrological
...
a stylistic distinction, this is highly inconvenient, as it requires
single numeric expressions to systematically use multiple fonts.
Further, if that contrast is lost in plain-text interchange, the text can
be misinterpreted:
{\xsuxfont 𒌍} is a length of three ropes, but {\curviform \threeUC} is an area of three bur₃;
{\curviform\oneAšC\xsuxfont 𒁹} could be read as one {\xsuxfont 𒄘𒁇} and one {\xsuxfont 𒃻𒋙𒊕},
where {\curviform\oneAšC\oneDišC} would be one and a half {\xsuxfont 𒄘𒁇};
{\xsuxfont 𒀸𒊕} is a personal name, but {\curviform\oneAšC\xsuxfont 𒊕} would be ``one slave''.
...
TODO mention the bariga silliness in the CDLI transliteration of Gori's paper.
...
\printbibliography[heading=subbibintoc,title={Other documents},nottype=artwork,notkeyword=unicode]
\end{document}