...
%the area {\xsuxfont 𒐐𒑘𒐂𒃷} could be transliterated as 5.1.4,
...
previously discussed in discussed in section~\ref{non-numeric}.
However, in lexical lists from Šuruppag and Ebla,
as well as in the \emph{\textfrench{Stèle des vautours}},
non-numeric šar₂ is curviform:\begin{itemize}
  ...
  however {\xsuxfont 𒀭𒉌} ⸢{\xsuxfont 𒊹}⸣{\xsuxfont 𒊏} on \cite[\obverse~6, 17]{P222399}.
...
the reference glyph should remain the same so that the contrast
