...
\subsubsection{P020054}
Some co-occurrence of curviform and cuneiform digits was known and acknowledged.
\cite[3]{L2/04-099} cites \cite[62]{NissenDamerowEnglund2007}, which is a copy of \cite{P020054},
...
so that it is wider than it is tall, and can at first look like a large \text{𒀸} in copies.
...
different appearance from those of the Ur III period used here;
the sign {\xsuxfont 𒌍} here looks more like Ur III {\xsuxfont 𒆳}.}
\begin{tabular}{l l l l l}
\xsuxfont 𒃷𒁉&
\curviform\oneUC&
...
\end{quote}
The argument made in \cite{L2/04-099} is that this is comparable to a stylistic distinction such as\footnote{We
have taken the liberty of adjusting the analogy in \cite[4]{L2/04-099}
to use measures approximately equal to those in \cite{P020054},
...
\end{quote}
where the numerals have the same structure (\cite{L2/04-099} contrasts this the different structures
...
in a single numerical expression''. It therefore comes to the conclusion that the use of curviform
numerals should be seen as a formatting distinction, rather than one that should be represented in plain text.
...
the distinction between curviform and cuneiform numerals is commonly used
to distinguish metrological systems.
In addition, we will show that some metrological systems
commonly mix curviform and cuneiform
in single numerical expressions.
...
a surface of $5~\text{\emph{būrū}}$ $1~\text{\emph{eblum}}$ $4~\text{\emph{ikû}}$ ($100~\text{\emph{ikû}}$, $36~\text{ha}$) would be written\footnote{As in the surface of the field of {\xsuxfont 𒀀𒅗𒋡𒆠} (the city of Apisal) reported on \href{https://cdli.mpiwg-berlin.mpg.de/artifacts/102305/reader/99066}{P102305} r. 1.}
...
[TODO(egg):The prose needs to be rewritten]
...
\cites[72]{Deimel1922}[63]{NissenDamerowEnglund2007}[378]{Friberg2007}{Gombert2016}:
\begin{equation}
\text{\curviform \oneŠarʾuC}
\xleftarrow{10}\text{\oneŠarTwoC}
...
in the ED I–II period (it is the ``area 2'' system in \cite{Chambon2003}, whereas \ref{systemGED} is the ``area 1'' system).
