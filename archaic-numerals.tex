...
The overall picture of unifications and disunifications over time is as follows:
\begin{center}
...
[TODO(egg): Present the argument from L2/04-099 detail, including the artifact cited.]
...
with curviform numerals, it is useful to understand
...
\subsection{Problems with unification: Early metrology}
\subsubsection{Scholarly publications}
\subsection{Problems with unification: Non-numeric usage}
\epigraph{
