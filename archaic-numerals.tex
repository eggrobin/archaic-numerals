...
\oneUC (small cylinder) or
\oneŠarTwoC{} (large cylinder),
or at a shallower angle:
\oneAšC, \oneDišC{} (small cylinder),
\oneŊešTwoC{} (large cylinder).
...
Impressed into clay using a trihedral stylus:
{\xsuxfont 𒀸} (stylus held horizontally),
{\xsuxfont 𒁹} (vertically),
{\xsuxfont 𒀹} (diagonally)
{\xsuxfont 𒌋} (diagonally with the stylus along its axis),
...
U+\textcsc{12550} \oneAšC{} \textsc{cuneiform numeric sign one N01},
