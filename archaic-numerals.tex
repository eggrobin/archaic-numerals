...
A more comprehensive overview of numeral usage in Eblaite capacity systems may be found in
\cite[141--144]{Gori2024}; exceptions exist, with {\xsuxfont 𒃻𒋙𒊕} occasionally counted in {\oneDišC} or
{\oneAšC} numerals. Note that the expression cited for \oneAšC{} numerals,
...
\cite{Gori2024} cites only {\xsuxfont 𒁹} for {\xsuxfont 𒀭𒍡} and only curviform numerals for integer {\xsuxfont 𒄘𒁇}.}.
