...
and ``Early Dynastic weights and measures'', have already been discussed in
§\ref{earlyMetrology}.
...
The $\frac12$ and $1~\text{ban₂}$ usages of
{\xsuxfont \oneBanTwoC}, contrary to the disunification
of U+\textcsc{12226} {\cuneiformComposite 𒈦} \textcsc{CUNEIFORM SIGN MASH}
and U+\textcsc{1244F} {\cuneiformComposite 𒑏} \textcsc{CUNEIFORM NUMERIC SIGN ONE BAN2}.
