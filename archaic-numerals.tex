...
\newcommand{\changed}[1]{\highLight{\strikeThrough{#1}}}
...
% their names follow archaic conventions where possible, see §\ref{unificationRationale}.
...
\begin{enumerate}[nosep]
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/3183\#155340}{\recto~1~1}]{P241904}\footnote{From photo in \cite[6]{Archi1989}.} {\fourAšC\xsuxfont 𒄘𒁇 𒐉\footnote{Laid out as {\xsuxfont 𒁹𒁹𒁹𒁹}; on stacking patterns see §\ref{stackingPatterns}.}𒃻𒋙𒊕}% EST 60 = RA 083, 001, fig. 1
