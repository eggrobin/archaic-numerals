...
\begin{equation}
  ...
  \xleftarrow{2}\underset{\substack{\text{gi}\\\text{\emph{qânum}}\\\text{reed}\\1,5~\text{m}}}{\text{\xsuxfont 𒁹𒄀}}
...
\begin{equation}
  ...
  \xleftarrow{10}\underset{\substack{\text{gi}\\\text{\emph{qânum}}\\\text{reed}\\1,5~\text{m}}}{\text{\xsuxfont 𒀹𒄀}}\text.
  \tag{$L_{\text{ED IIIb}}$}
  \label{systemLED}
\end{equation}
This is the system that was used to express the sides of the field discussed in
section~\ref{oldArgumentsForUnification}.
