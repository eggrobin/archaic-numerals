...
from that period, as illustrated in figures TODO.
...
There are transliteration conventions that are more explicit about numeral shape,
such as the ones used by [TODO Gori has the wrong page number but Englund does the fun thing too]
\cites[118\psq]{Englund1998}[39]{Molina2014}, cited by \cite[\pno~160 with note 4]{Gori2023};
here one could write something along the lines of\footnote{This style is used in Oracc transliterations.}
...
\begin{figure}
  ...
  \caption{Discussion of the contrast between {\curviform \oneAšC} and {\curviform \oneDišC} numerals in \cite[162]{Gori2023}}
  \end{center}
\end{figure}
