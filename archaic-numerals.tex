...
\begin{itemize}[nosep]
  \item \cite[\obverse~1~4]{P221305}\footnote{\cite{CDLI} only has a copy, but a photo may be found in
...
Section~\ref{transliteration}, \cite{CDLI} transliterations indicate numeral shape; however,
...
\begin{enumerate}[nosep]
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/3173\#154945}{\recto~1~1}]{P241708}\footnote{From \cite{CDLI} photo.} {\twoAšC\oneDišC\xsuxfont 𒆗 𒄘𒁇 𒐌𒃻𒋙𒊕}% 2 1/2 sig₁₅ gu₂-bar 7 nig₂-sagšu  EST 50 https://cdli.mpiwg-berlin.mpg.de/artifacts/241708/reader/133004
