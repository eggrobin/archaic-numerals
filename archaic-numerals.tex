...
\cites[459]{Powell1987}[118]{Friberg2007}{Robson2019}:
\begin{equation}
  \text{\xsuxfont 𒐕𒆜𒁍}
  \xleftarrow{30}\text{\xsuxfont 𒁹𒍑}
  \xleftarrow{6}\text{\xsuxfont 𒁹𒂠}
  \xleftarrow{10}{\text{\xsuxfont 𒁹𒃻}}
  \xleftarrow{2}{\text{\xsuxfont 𒁹𒄀}}
  \xleftarrow{6}{\text{\xsuxfont 𒁹𒌑}}
  \xleftarrow{30}{\text{\xsuxfont 𒁹𒋗𒋛}}\text.
  \tag{L\textsubscript{Ur III/OB}}
  \label{systemLOB}
\end{equation}

\subsubsection{Fractions}
TODO
Note the existence of a name for $\text{\xsuxfont 𒈦𒂠}=\text{\xsuxfont 𒐊𒃻}$, cite Robson p. 294 and 2022.
