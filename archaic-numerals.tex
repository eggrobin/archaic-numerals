...
Mroe explicit conventions,
such as $4(\text{AŠᶜ})$ \emph{ʾa₃-da-um} $4(\text{DIŠᶜ})$ \emph{aktum} $4(\text{AŠᶜ})$ ib₂\textsuperscript{tu₉}×$3(\text{DIŠ})$ sa₆ gunu₃,
would be less readable. See
Section~\ref{transliteration} for a discussion of transliteration conventions for numerals.

TODO Gori cites Englund, dig that up.
