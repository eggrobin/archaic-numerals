...
\usepackage{fancyhdr}
\pagestyle{fancy}
\newcommand{\thisDocumentNumber}{L2/24-210R}
\newcommand{\thisDocumentTitle}{Archaic cuneiform numerals}
\fancyfoot{}
\fancyhead{}
...
A \textattachfile{archaic-numerals-chart-scx.pdf}{highlighted chart} is attached to this document,
providing an overview of the Script\_Extensions values for the proposed characters (yellow for Xsux, green for Pcun).
Characters with Script\_Extensions=$\{\text{Xsux}, \text{Pcun}\}$ have Script=Cuneiform,
reflecting the expectation that they will more frequently be used in third millennium scholarship than
fourth millennium scholarship.
...
\begin{quote}
\textit{Editor's note: The dashed-box convention for wide dashes, see \cite[§24.1.2, \emph{sub}
``\href{https://www.unicode.org/versions/Unicode16.0.0/core-spec/chapter-24/\#G8188}{Dashed Box Convention}'']{Unicode16}
should probably not be extended to these characters,
...
\textattachfile{archaic-numerals-ucd/NamesList.txt}{NamesList.txt} lines is
attached to this document.
\vspace{0pt plus 0.5fill}
\begin{center}This space for rent.\end{center}
\vfill
\includepdf[pages=-]{archaic-numerals-chart.pdf}
...
Attached: \textattachfile{archaic-numerals-ucd/UnicodeData.txt}{UnicodeData.txt}.
\VerbatimInput{archaic-numerals-ucd/UnicodeData.txt}
\subsubsection{Line\_Break}
Attached: \textattachfile{archaic-numerals-ucd/LineBreak.txt}{LineBreak.txt}.
\VerbatimInput{archaic-numerals-ucd/LineBreak.txt}
\subsubsection{Script}
Attached: \textattachfile{archaic-numerals-ucd/Scripts.txt}{Scripts.txt}.
\VerbatimInput{archaic-numerals-ucd/Scripts.txt}
\subsubsection{Script\_Extensions}
Attached: \textattachfile{archaic-numerals-ucd/ScriptExtensions.txt}{ScriptExtensions.txt}.
\VerbatimInput{archaic-numerals-ucd/ScriptExtensions.txt}
\subsubsection{Block}
Attached: \textattachfile{archaic-numerals-ucd/Blocks.txt}{Blocks.txt}.
\VerbatimInput{archaic-numerals-ucd/Blocks.txt}
...
copies of parts of the laws of {\xsuxfont 𒄩𒄠𒈬𒊏𒁉}, as well as Old Babylonian copies in both archaizing
and cursive styles.
...
\footnotetext{See \cite{Civil1985}.}%
...
\label{systemGOB}
\]
\exempligratia, \smash{\xsuxfont 𒐣𒃲𒐭𒐸𒐔𒐃𒃷𒐊𒈦𒊬𒌋𒐎𒂆}\footnote{From \cite[\href{http://oracc.org/dccmt/P213162.4}{\obverse~2}]{P213162},
...
\text{ of grain.}
\end{matrix}\]%
\footnotetext{From \cite[\href{http://oracc.org/epsd2/P309594.3}{\obverse~1}]{P309594}.}%
...
\begin{itemize}[nosep]
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://oracc.org/epsd2/P221305.7}{\obverse~1~4}]{P221305}}\footnote{\cite{CDLI} only has a copy, but a photo may be found in
...
%  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://oracc.org/epsd2/P221305.20}{\reverse~1~1}]{P221305}} {\oneŊešTwoC\fourUC\oneBanTwoC\xsuxfont 𒂠𒑍𒄀} % 1(gesz2@c) 4(u@c) 1/2(asz@c) esz2 5(disz@t) gi
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://oracc.org/epsd2/P020129.21}{\reverse~2~1}]{P020129}} {\sixŊešTwoC\threeUC\xsuxfont 𒃻𒁺\oneBanTwoC\xsuxfont 𒑌𒄀} % 6(gesz2@c) 3(u@c) {ninda}nindax(DU) 1/2(asz@c) 4(disz@t) gi
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://oracc.org/epsd2/P221291.84}{\reverse~5~1}]{P221291}}\footnote{From copy.} {\oneŊešʾuC\twoŊešTwoC\fourUC\oneBanTwoC\xsuxfont 𒂠𒃻𒁺𒑊𒄀𒌑𒑋} % 1(gesz'u@c) 2(gesz2@c) 4(u@c) 1/2(asz@c) esz2 {ninda}nindax(DU) 2(disz@t) gi kusz3 3(disz@t)
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://oracc.org/epsd2/P221266.34}{\reverse~2~1}]{P221266}} {\oneAšC\oneBanTwoC\xsuxfont 𒂠𒑋𒄀} % 1(asz@c) 1/2(asz@c) esz2 3(disz@t) gi
\end{itemize}
...
\cite[\href{http://oracc.org/epsd2/P020129.15}{\obverse~3~3}]{P020129} {\threeŊešTwoC\fourUC\oneBanTwoC}.}
...
\end{equation}
as in \cites[\href{http://oracc.org/epsd2/P020016.26}{\reverse~1~4}]{P020016}{P020065}[\href{http://oracc.org/epsd2/P020090.6}{\obverse~1~3};\href{http://oracc.org/epsd2/P020090.35}{\reverse~2~1}]{P020090}[\href{http://oracc.org/epsd2/P020092.69}{\reverse~3~1}]{P020092}[\href{http://oracc.org/epsd2/P020137.5}{\obverse~1~2}]{P020137} and others,
...
4(ban2@c) 3(asz@c) sila3 in \cite[\href{http://oracc.org/epsd2/P221815.36}{\obverse~4~7}]{P221815}, is incorrect: it should be 4(ban2@c) 3(disz@t) sila3.}
...
see, \exempligratia, \cite[\href{http://oracc.org/epsd2/P020092.69}{\reverse~3~1};\href{http://oracc.org/epsd2/P020092.70}{2}]{P020092}.
...
in \cite[\href{http://oracc.org/epsd2/P221746.26}{\reverse~2~2}]{P221746} and {\xsuxfont 𒊺 𒍩 \oneUC\threeBanTwoC 𒑌𒋡 𒄥𒑊𒌌}
in \cite[\href{http://oracc.org/epsd2/P221814.34}{\reverse~1~5}]{P221814}.
...
and the smaller units using cuneiform {\xsuxfont 𒁹} numerals\footnote{For a more comprehensive overview of numeral usage in Ebla
which we unfortunately found late in the preparation of this proposal, see \cite{Gori2024}; exceptions exist.
Note that the example for \oneAšC{} numerals counting {\xsuxfont 𒃻𒋙𒊕} cited in \cite[\pno~143 \withnote~592]{Gori2024},
\cite[\href{http://ebda.cnr.it/tablet/view/1324\#57956}{\recto~1~7}]{P240532} {\xsuxfont\fourAšC 𒃻𒋙𒊕},
does not use the higher units; on the same tablet,
\cite[\href{http://ebda.cnr.it/tablet/view/1324\#58045}{\verso~4~9}]{P240532} (item~\ref{P240532-v-4-9}), which does,
uses {\xsuxfont 𒁹} numerals for the {\xsuxfont 𒃻𒋙𒊕}.
\cite[141--143]{Gori2024} cites only {\xsuxfont 𒁹} for {\xsuxfont 𒀭𒍡} and only curviform numerals for integer {\xsuxfont 𒄘𒁇}.
As mentioned in \cite[63]{Chambon2012}, the {\xsuxfont 𒂆} is also counted using the \oneBanTwoC{}--\fourBanTwoC{} numeral series.
...
\begin{enumerate}[nosep]
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://ebda.cnr.it/tablet/view/1324\#58045}{\verso~4~9}]{P240532}} {\oneAšC\xsuxfont 𒊺 𒁀𒌷𒅗\footnote{ba-ri₂-zu₂, a variant spelling.}𒐊𒃻𒋙𒊕}\label{P240532-v-4-9}% v.4,9 1 še ba-ri₂-zu₂ 5 nig₂-sagšu % ARET 09 0010 
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://ebda.cnr.it/tablet/view/1350\#59630}{\verso~1~1}]{P240548}} {\oneAšC\xsuxfont 𒁀𒌷𒍪 𒐈𒀭𒍡} % ARET 09 0036 1 ba-ri₂-zu 3 an-zamᵪ
  ...
  \item {\addfontfeatures{Numbers=Tabular}\cite[\href{http://ebda.cnr.it/tablet/view/1383\#62337}{\recto~2~6}]{P240654}} {\oneAšC\xsuxfont 𒁀𒌷𒍪 𒐋𒋡\footnote{Instead of the expected {\xsuxfont 𒃻𒋙𒊕}.} 𒐈𒀭𒍡\footnote{{\xsuxfont 𒐈𒀭𒍡} not legible on the \cite{EbDA} photo.}}% 1 ba-ri₂-zu 6 sila₃ 3 an-zamᵪ % ARET 09 0069
...
it also stands for `sixty'\footnotemark. Do you know its reading\footnotemark?}}{Examenstext A\footnotemark}
...
\footnotetext{Besides ŋeš₂, a look at \cite{OSL} shows that the values
...
\stepcounter{footnote}
\footnotetext{Translation from and composite text after \cite{BLMS}.}
...
\begin{itemize}[nosep]
  ...
  \item {\xsuxfont 𒀸𒊕}\footnote{Possibly a toponym, see \cite[195]{Postgate2024}.} in
  \cites[\href{http://oracc.org/epsd2/P010424.29}{\reverse~1~5}]{P010424}[\href{http://oracc.org/epsd2/P010458.8}{\obverse~1~5}]{P010458}[\href{http://oracc.org/epsd2/P010459.15}{\obverse~2~5′}]{P010459}
  from ED IIIa \smash{\textarabic{أبو صلابيخ}},
  \item {\xsuxfont 𒀸𒉌} in \cite[\href{http://oracc.org/epsd2/P010960.15}{\obverse~2~5}]{P010960} from ED IIIa Šuruppag,
  % \item {\xsuxfont 𒀸𒁯𒌦𒄷} in \cite[\href{http://oracc.org/epsd2/P010964.123}{\obverse~7~18}]{P010964} from ED IIIa Šuruppag, % FIXCDLI Nope, 𒀾
  \item {\xsuxfont 𒆷𒈠𒀸𒁯} in \cite[\href{http://oracc.org/epsd2/P251641.44}{\obverse~4~3}]{P251641} from ED IIIb Adab,
  \item {\xsuxfont 𒅤𒊭𒀸𒁯} in \cite[\href{http://oracc.org/epsd2/P252866.14.2}{\obverse~2~3}]{P252866} from ED IIIb Adab,
  \item {\xsuxfont 𒈗𒋗𒀸𒉌} in \cite[\href{http://oracc.org/epsd2/P298637.48}{\reverse~2~4}]{P298637} from ED IIIb Umma;
  \end{itemize}
  \item in the Sumerian word {\xsuxfont 𒌑𒀸} u₂-rum, ``property'' in ED IIIb Ŋirsu administrative texts which contain
    ...
    \cites[\href{http://oracc.org/epsd2/P020006.11}{\obverse~2~3}]{P020006}[\href{http://oracc.org/epsd2/P020008.27}{\reverse~1~2}]{P020008}[\href{http://oracc.org/epsd2/P020018.16}{\reverse~1~2}]{P020018}[\href{http://oracc.org/epsd2/P020024.7}{\obverse~1~4}]{P020024}[\href{http://oracc.org/epsd2/P020030.16}{\obverse~3~1}]{P020030};
  \item in lexical texts:
  \begin{itemize}[nosep]
    \item in the divine name {\xsuxfont 𒀭𒎏𒉾𒀸𒁇} in the lexical texts \cites[\href{http://oracc.org/dcclt/P010570.75}{\reverse~2~4}]{P010570}[\href{http://oracc.org/dcclt/P010572.25}{\obverse~3~6}]{P010572},
      where the entries are prefixed with {\oneAšC}.
    \item in the word {\xsuxfont 𒀸} dili, ``small fish'' in
    \cite[\href{http://oracc.org/dcclt/P010578.24}{\obverse~2~5}]{P010578}, witness to Early Dynastic Fish,
    \item in the same word with a determinative, {\xsuxfont 𒀸𒄩} dili\textsuperscript*{ku₆},
    in \cite[\href{http://oracc.org/dcclt/P010586.55}{\obverse~4~4};\href{http://oracc.org/dcclt/P010586.57}{6}]{P010586},
...
the ED IIIa witness \cite[\href{http://oracc.org/epsd2/P222243.24}{\obverse~2~7}]{P222243}, also discussed
in §\ref{šar₂}, and
...
%\item \cite[\href{http://oracc.org/epsd2/P010263.72}{\reverse~5~3}]{P010263}, ED IIIa literary; % NOTE(egg): Lisman reads that ḫe, so let’s not go there.
\item {\xsuxfont 𒂗𒆠𒊹𒊏} in \cite[\href{http://oracc.org/epsd2/P020019.18}{\reverse~1~2}]{P020019} from ED IIIb Ŋirsu;
\item {\xsuxfont 𒂄𒈨𒊹𒊏𒁺} in \cite[\href{http://oracc.org/epsd2/P020182.26}{\obverse~2~9}]{P020182}, also from ED IIIb Ŋirsu; 
\item {\xsuxfont 𒊩𒀭𒊹} in \cite[\href{http://oracc.org/epsd2/P222186.36}{\obverse~3~3}]{P222186} from ED IIIb Umma;
\item {\xsuxfont 𒌨𒀭𒀀𒊹} in \cite[\href{http://oracc.org/epsd2/P235312.18}{\obverse~16}]{P235312} from Old Akkadian Umma.
\end{itemize}},
...
non-numeric šar₂ is curviform:\begin{itemize}[nosep]
  \item {\originalNoto 𒀭𒂗𒆠𒊹} and {\originalNoto 𒀭𒂗𒊹𒉡𒄄} in \cite[\href{http://oracc.org/dcclt/P010566.287}{\obverse~10~10};\href{http://oracc.org/dcclt/P010566.288}{11}]{P010566};
  \item {\originalNoto 𒊹𒄈} and {\originalNoto 𒀭𒊹𒄈} in \cite[\href{http://oracc.org/dcclt/P010576.192}{\reverse~3~16};\href{http://oracc.org/dcclt/P010576.193}{17}]{P010576};
  ...
  \item {\originalNoto 𒊹𒊏𒈾} in \cite[\href{http://oracc.org/etcsri/Q001056.271}{\obverse~17~9};\href{http://oracc.org/etcsri/Q001056.321}{18~11};\href{http://oracc.org/etcsri/Q001056.434}{22~12}]{P222399}\footnote{Note
  however {\xsuxfont 𒀭𒉌 𒊹𒊏} on \cite[\href{http://oracc.org/etcsri/Q001056.110}{\obverse~6~17}]{P222399}, see 
...
\begin{figure}
  \begin{center}
    ...
    \caption{\cite[\href{http://oracc.org/etcsri/Q001056.109}{\obverse~6~16--17}]{P222399} {\xsuxfont 𒃶𒊒𒁉} / {\xsuxfont 𒀭𒉌 𒊹𒊏}.\label{vultureSquare}}      
  \end{center}
\end{figure}
...
in those cases, with its curviform glyph {\originalNoto 𒊹},
...
Note that in rare cases, such as \cite[\href{http://oracc.org/epsd2/P222243.24}{\obverse~2~7}]{P222243} from ED IIIa Adab,
...
from \cite[\href{http://oracc.org/epsd2/P020129.21}{\reverse~2~1}]{P020129} is transliterated
...
The ``tradition of cavalierly dispensing with numerical notations in editions
...
\cite[\href{http://oracc.org/epsd2/P283802.66}{\reverse~1~6};\href{http://oracc.org/epsd2/P283802.71}{2~2}]{P283802} currently uses (barig@c) for the vertical numerals,
...
% FIXCDLI: 4(N04@f), not 2(N04@f).
is \oneNThirtySixFlat\twoNFortySixFlat\twoNNineteenFlat\fourNFourFlat in
\cite{P005773}.
...
as it is unclear how it is transliterated in \cite{CDLI}.
The use of this sign in Ebla is elaborated on in \cite[\pno~142 \withnote~583]{Gori2024}: it is used for a quarter
{\xsuxfont 𒄘𒁇}, (or equivalently, a half {\xsuxfont 𒁀𒌷𒍪}), transliterated $1/4$ in \cite{EbDA},
whereas {\oneBanTwoC} is used for a sixth of a {\xsuxfont 𒄘𒁇}.
It may be proposed for encoding in the Archaic Cuneiform Numerals block in a future proposal.
...
\begin{center}
  ...
  \caption{The layout of case \cites[\href{http://oracc.org/epsd2/P011099.19}{\reverse~2~3}]{P011099}; the numeral \twoUC{} is rotated to fit the rounded corner of the tablet.}
  \label{cheese}
\end{center}
\end{figure}
\begin{figure}
...
\begin{center}
  ...
  \caption{The layout of case \cites[\href{http://oracc.org/epsd2/P020066.4}{\obverse~1~1}]{P020066}; the numeral \twoUC{} is spread across two lines.
...
\]
  ...
  ED~IIIa Šuruppag \cite[\href{http://oracc.org/dccmt/P010678.4}{\obverse~2}]{P010678},
  ED~IIIb Ŋirsu \cite[\href{http://oracc.org/epsd2/P020057.6}{\obverse~1~3}]{P020057},
...
Ned Holbrook reviewed the property assignments.
...
\addcontentsline{toc}{section}{Modifications}
The following summarizes modifications from the previous version of this document (L2/24-210).
\begin{itemize}
  \item Attached a highlighted copy of the code charts summarizing the Script\_Extensions property assignments.
  \item Clarified the descriptions of the Script and Script\_Extensions property assignments in §\ref{summary}.
  \item Corrected the names of U+\textcsc{1245D} \smash{\cuneiformComposite 𒑝} \textcsc{CUNEIFORM NUMERIC SIGN ONE THIRD\strikeThrough{ DISH} VARIANT FORM A}
  and U+\textcsc{1245E} \smash{\cuneiformComposite 𒑞} \textcsc{CUNEIFORM NUMERIC SIGN TWO THIRDS\strikeThrough{ DISH} VARIANT FORM A} in names list cross references in §\ref{charts}.
  \item Corrected a typo in a citation of \cite{Englund2004} in §\ref{transliteration}.
\end{itemize}
\includepdf[pages=-2]{archaic-numerals-summary-form.pdf}
\end{document}