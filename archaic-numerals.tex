...
\begin{itemize}
  ...
  $N_{17}$ is only attested in a witness to \cite{Q000028}.
  $N_{16}$ is attested in similar context in the same witness to \cite{Q000028},
  but also in \cite{P283918} and \cite{P283919}
  where notes by Englund in the \cite{CDLI} transliteration suggest it is numeric,
  equal to $\frac{1}{20}\text{\oneNThirtyNineA}$.
...
The following numeral series from \cite{L2/23-190}

TODO $12N_{14}$ not encodable, etc. Cite \cite[147]{DamerowEnglund1987}
N30C\~b not attested
