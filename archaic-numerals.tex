...
\newcommand\oneEšeThreeC{{\proposalfont\symbol{"12589}}}
\newcommand\oneBurʾuC{{\proposalfont\symbol{"1258E}}}
\newcommand\oneBanTwoC{{\proposalfont\symbol{"12593}}}
\newcommand\oneNThirtyA{{\proposalfont\symbol{"125C2}}}
\newcommand\oneNThirtyC{{\proposalfont\symbol{"125C3}}}
\newcommand\oneNTwentyNineA{{\proposalfont\symbol{"125C9}}}
...
section~\ref{transliteration}; they are indeed used interchangeably, as in TODO which uses the notation
TODO in \cite{ePSD2}, but TODO in CDLI.
...
TODO ($N_{17}$ not usefully numeric, $12N_{14}$ not encodable, etc.).
...
\subsection{Other lyph variants not reflected in transliteration}
