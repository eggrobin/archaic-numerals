...
with $1~\text{sar}=1~\text{\emph{mūšarum}}\approx36~\text{m}^2$ written {\xsuxfont 𒁹𒊬}, equal to one hundredth of an \emph{ikûm},
then sexigesimally subdivided in $60~\text{\xsuxfont{𒂆}}$ (ŋin₄, \emph{šiqlū}, shekels).
...
as follows \cites[\pno~295 \withnote~b and c]{Robson2008}[378]{Friberg2007}{Robson2019}: \[\small
...
which has an additional {\xsuxfont 𒑛𒊭}, two thirds (of a shekel), see section~\ref{fractions}.}
...
Further, we have used the symbol $\curvearrowright$ to express that, as described in \cite[\pno~585 \withnote~(b) and (f)]{Huehnergard2011},
