...
The following are attestated capacity measures from Ebla\footnote{This list was compiled by searching EbDA for co-occurrences of {\xsuxfont 𒀭𒍝} an-zamₓ with a larger unit on the same line;
only tablets with photographs in EbDA were considered,
as the transliterations there do not distinguish curviform from cuneiform numerals;
only one attestation per tablet is listed.}:
\begin{itemize}[nosep]
  \item \cite{EbDATODO} {} % 1 ba-ri₂-zu 3 an-zamᵪ http://ebda.cnr.it/tablet/view/1350#59630
  \item \cite{EbDATODO} {\curviform\oneAšC\xsuxfont 𒁀𒌷𒍪𒐈𒀭𒍝}% http://ebda.cnr.it/tablet/view/1378#61605 1 ba-ri₂-zu 3 an-zamᵪ
  \item \cite[r.1,3]{EbDA1379} {\curviform\twoUC\threeAšC\oneDišC\xsuxfont 𒄘𒁇\curviform\oneAšC\xsuxfont 𒃻𒌋𒊕𒈫𒈦𒀭𒍝}% #61615 20-3-1/2 gu₂-bar 1 nig₂-sagšu 2-1/2 an-zamᵪ
\end{itemize}

[TODO(egg):Eblaite capacities \cite{P240964}
TODO(egg): There are ŋeš₂ gubar
TODO(egg): the diš are unusual in P240964, compare http://ebda.cnr.it/tablet/view/1379]
\begin{equation}
  \underbrace{
