...
``numerals have omitted due to the complexity of numeral signs from this period.
...
\subsubsection{Cheese and wheat in Ŋirsu}
...
the single occurrence of (ban2@c) followed by curviform numerals and sila3 in CDLI,
4(ban2@c) 3(asz@c) sila3 in \cite[\obverse~4, 7]{P221815}, is incorrect: it should be 4(ban2@c) 3(disz@t) sila3.}
in combination with larger units. This contrast can be seen in \cite{P220927},
which counts butter ({\xsuxfont 𒉌}, i₃) in {\xsuxfont 𒂁\sixAšC 𒋡}, {\xsuxfont 𒂁\eightAšC 𒉌𒋡}, and {\xsuxfont 𒂁\oneUC\twoAšC 𒋡}, pots of six, eight, and twelve sila₃,
themselves counted using the discrete counting system\footnote{Including the fraction {\xsuxfont 𒑞}, and with subtractive notation, \exempligratia,
{\xsuxfont\twoAšC 𒂁𒇲𒑞} ``two pots (of one sila₃) minus one third (pot)'',
or in the total, {\xsuxfont\oneUC 𒇲\oneAšC 𒂁\sixAšC 𒋡} ten minus one pots of six sila₃.
Such subtractive notation is common in most of the metrological systems discussed here; it appears in the ED IIIa period \cite[77]{Robson2008},
but it presents no complexity for character encoding. The sign {\xsuxfont 𒇲} (lal₂, ``minus'')
is often ligated with the following numerals, with the subtrahend placed under a sometimes considerably enlarged {\xsuxfont 𒇲},
similar to the layout of the radical in modern mathematical notation;
see \cite[\reverse~3,1;2]{P020092}.},
but counts cheese ({\xsuxfont 𒓻}, gaʾar) using the {\xsuxfont 𒄥𒊕𒅅} capacity system, with {\xsuxfont 𒀹} numerals for the sila₃.
% FIXCDLI P221815 4(ban2@c) 3(asz@c) sila3 should be 4(ban2@c) 3(disz@t) sila3.

It is not only pots that come in multiple sizes in ED IIIb Ŋirsu, but also {\xsuxfont 𒄥}.
Another capacity system is the {\xsuxfont 𒄥𒑊𒌌}, the gur of two ul:
\begin{equation}
