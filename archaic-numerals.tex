...
\begin{equation}
  ...
  \xleftarrow{6}\underset{\text{an-zamₓ}}{\text{\xsuxfont 𒀭𒍡}}
  \tag{$C_{\text{Ebla}}$}
  \label{systemCEbla}
\end{equation}
...
\begin{enumerate}[nosep]
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1381\#61931}{\recto~1, 5}]{P240697} {\curviform\oneAšC\oneDišC\xsuxfont 𒄘𒁇 𒈫𒂆 𒐈𒀭𒍡}% ARET 09 0067 r.1,5	1-1/2 ❮gu₂-bar❯ 2 GIN₂ 3 an-zamᵪ
  ...
  \item \cite[\href{http://ebda.cnr.it/tablet/view/1383\#62337}{\recto~2, 6}]{P240654} {\curviform\oneAšC\xsuxfont 𒁀𒌷𒍪 𒐋𒋡 𒐈𒀭𒍡\footnote{{\xsuxfont 𒐈𒀭𒍡} not legible on the EbDA photo.}}% 1 ba-ri₂-zu 6 sila₃ 3 an-zamᵪ % ARET 09 0069
...
Note that higher numbers of {\text{\xsuxfont 𒄘𒁇}} are expressed in hundreds, as is typical in Ebla \cite[33]{Archi2015} %http://ebda.cnr.it/tablet/view/1324#58017
