...
Another such systems of note is the one for volumes,
\begin{equation}
\underbrace{
...
\xleftarrow{\ 10\ }\underset{\mathclap{\substack{1~\text{sila₃}\\1~\text{\emph{qûm}}\\1~\text{l}}}}{\text{\xsuxfont 𒁹𒋡}}
\xleftarrow{\ 60\ }\underset{\mathclap{\substack{1~\text{giŋ₄}\\1~\text{\emph{šiqlum}}}}}{\text{\xsuxfont 𒁹𒂆}}\text,
\tag{C}
\label{systemC}
\end{equation}
...
after the overt unit sign {\xsuxfont 𒋡} if present, and after the word for ``grain'' if present, as in {\xsuxfont 𒐢𒐝𒌋𒐂𒑑𒐋𒋡𒊺𒄥}
($3554$~gur $3$~ban₂ $6$~sila₃ of grain\footnote{From \href{https://cdli.mpiwg-berlin.mpg.de/artifacts/309594}{P309594}}.).
Observe that while large number of gur follow system \ref{systemSOB},
...
\item {\xsuxfont 𒀸}–{\xsuxfont 𒐇} used in TODO;
...
\item {\xsuxfont 𒑘} and 	{\xsuxfont 𒑙} used in TODO;
\end{itemize}
...
\section{Non-numeric usage and the ŠAR₂ problem}
\epigraph{
