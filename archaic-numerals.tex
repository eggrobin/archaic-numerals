...
later in the third millenium\footnote{Merging with U+1224E {\xsuxfont 𒉎} NI₂.},
...
whereas non-numeric {\xsuxfont 𒀸} is at the beginning of the sign list given with its values \emph{aš} and \emph{rum}.
For signs with both non-numeric and numeric usage, \cite{Deimel1922} writes \emph{\textgerman{s. die Zahlz.}}
throughout the main list; LAK1 {\xsuxfont 𒀸} thus reappears at LAK829 together with
{\curviform \oneAšC}, {\xsuxfont 𒀹}, and {\xsuxfont 𒁹}.
One should note \cite{Borger2010}, which has numbers throughout the sign list;
but that sign list does not use glyphs predating the Old Babylonian period,
...
and later; the kinds of texts that do, such as lexical and literary texts, do not
...
[TODO(egg): Cite the GitHub repository],
...
prominently Noto Sans Cuneiform, a system font on both Windows—as part of Segoe UI Historic—and macOS.} being good enough;
...
[TODO U+122B9 \textsc{CUNEIFORM SIGN SHAR2}
 ...
 \label{šar₂} [TODO Mention P222243]
