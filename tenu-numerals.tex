...
\begin{figure}[H]
  ...
  \end{center}
  \caption[]{{\xsuxfont 𒐕𒎙\footnotemark\sevenAshTenu{}𒄀𒊕} ``$501$~m (first) width'' (of a field) in \cite[\obverse~3~7]{P221254} from Ŋirsu.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont \sevenAshTenu{}𒄀 𒂊 𒆹} ``$21$~m of reed-bed dyke'' (attributed to {\xsuxfont 𒌨𒁮} the farmer) in \cite[\obverse~1~1]{P221266} from Ŋirsu. Left: Copy from \cite{AllottedelaFuÿe1908}.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption[]{{\xsuxfont\threeŊešTwoC\fourUC 𒃻𒁺\eightAshTenu 𒄀 𒃴\footnotemark{}𒁉 𒌑𒑌} ``$1344$~m, its height $2$~m'' (dimensions of a dyke on the river {\xsuxfont 𒊊𒌉𒁕𒈿𒀀𒀭}) in \cite[\obverse~2~2]{P020303} from Ŋirsu. Left: Copy from \cite{Marzahn1991}.
...
\begin{figure}[H]
  ...
  in \cite[\reverse~3~5--7]{P020182} from Ŋirsu.
...
\begin{figure}[H]
  ...
  in \cite[\reverse~2~5--6]{P221730} from Ŋirsu.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\sevenAshTenu{}𒄰} ``seventh day'' in \cite[\reverse~2~7]{P220703} from Ŋirsu.
  Left: Copy from \cite{AllottedelaFuÿe1908}. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌗𒌓\nineAshTenu{}𒉌𒆷} ``ninth day passed'' in \cite[\obverse~1~1]{P452986}.
