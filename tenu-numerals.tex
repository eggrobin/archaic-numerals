...
Early Dynastic metrological systems, and in particular in the length systems
\begin{alignat}{3}
  \text{\xsuxfont 𒐕}
  \xleftarrow{\ \ \ 6\ \ \ }
  {\text{\xsuxfont 𒌋}}&
  ...
  \xleftarrow{10}&\underset{\substack{\text{gi}\\\text{reed}\\3~\text{m}}}{\underbrace{\text{\xsuxfont 𒀹}}_{\text{\xsuxfont 𒄀}}}
  ...
  \label{systemLpED}
\end{alignat}
While these systems have a unit $1~\text{\xsuxfont 𒃻𒁺}=5~\text{\xsuxfont 𒄀}$,
lengths are only expressed in {\xsuxfont 𒂠}, or equivalently in tens of {\xsuxfont 𒃻𒁺}, or in
half-{\xsuxfont 𒂠} equal to $10~{\xsuxfont 𒄀}$.
Lengths of $5$--$9~{\xsuxfont 𒄀}$ therefore frequently occur, and are expressed using
{\xsuxfont 𒀹} numerals.
