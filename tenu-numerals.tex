...
\newcommand{\thirdAngle}{
  \begin{tikzpicture}[scale=.2]
    ...
    \draw [thick] (1.5,0.5) -- (3.5,1) -- (3.5,-1) -- (1.5,-0.5) -- cycle;
    \draw [dash=on 2.4mm off 0.25mm on 0.1mm off 0.25mm phase 1.2mm] (-1.5,0) -- (4,0);
    \draw [dash=on 2.4mm off 0.25mm on 0.1mm off 0.25mm phase 1.2mm] (0,1.5) -- (0,-1.5);
  \end{tikzpicture}
}
...
\fancyhead[CE]{\thisDocumentTitle{} \changed{{\xsuxfont 𒉡 𒀠𒌀}}}
...
The cuneiform font \textattachfile{CuneiformComposite.ttf}{CuneiformComposite.ttf}
used to produce this chart is attached to this document.
...
\section{DIŠ \emph{tenû} numerals}\label{dištenû}
...
Some\footnote{Besides \emph{tenû},
the terms \emph{gunû} ``speckled'' (with wedges),
\emph{nutillû} ``unfinished'', and \emph{šeššig} (filled with {\xsuxfont 𒊺} ŠE) are used.
Contrast however the use of \textcsc{CROSSING} rather than
\emph{gilimû}, \textcsc{OPPOSING} rather than \emph{igi-gubû}, or
\textcsc{SQUARED} rather than \emph{limmubi igi-gubû}.} technical terms used in cuneiform character names are derived from the structural descriptions of
cuneiform signs by Akkadian-speaking scribes in late second and first millennium lexical texts.
In particular, the word \emph{tenû} \cites[66\psq]{Gong1993}[32\psqq]{Gong2000}[12\psq]{Gong2003}
is used to describe slanted signs or parts of signs: thus {\xsuxfont 𒋙} is described as {\xsuxfont 𒁇} \emph{tenû} in \cite[\href{http://oracc.org/dcclt/P365233.226}{\reverse~1~46′}]{P365233}\footnote{Note that
...
{\xsuxfont 𒃸} as {\xsuxfont 𒃷} \emph{tenû} in \cites[\href{http://oracc.org/dcclt/P391514.290}{\reverse~2~47}]{P391514}
and as {\xsuxfont 𒂠} \emph{tenû} [\obverse~2~80]{P467315},
{\xsuxfont 𒄪} as {\xsuxfont 𒄩} \emph{tenû} in \cite[\href{http://oracc.org/dcclt/P391514.116}{2~33}]{P391514},
{\xsuxfont 𒆿} as {\xsuxfont 𒆸} (containing) {\xsuxfont 𒀸} \emph{tenû} in \cite[\href{http://oracc.org/dcclt/P365267.22}{\obverse~16′}]{P365267}\footnote{These
descriptions also spell out the names of the component signs;
as today, they are named after one of their values:
{\xsuxfont 𒃷} \emph{tenû} is written
{\nafont 𒂵𒈾𒋼𒉡𒌑} \emph{ga-na te-nu-u₂} after the value gan₂,
{\xsuxfont 𒂠} \emph{tenû} as {\nafont 𒊺𒋼𒉡𒌑} \emph{še te-nu-u} after the value še₃.
...
the latter being the norm in \cite{CDLI} transliterations\footnote{For an example of a transliteration using aš tenû, see
...
\cite[\href{http://oracc.org/epsd2/P109346.40}{\obverse~2~15}]{P109346} \smash{\xsuxfont 𒐉𒂆𒇲𒐌𒊺𒆬𒄀} ``$4$~shekels minus $7$~grains of gold'',
...
{\xsuxfont\threeŊešTwoC\fourUC\oneBanTwoC 𒇲𒀹𒄀} in \cite[\href{http://oracc.org/epsd2/P020129.15}{\obverse~3~3}]{P020129},
{\xsuxfont\oneŊešTwoC\fiveUC 𒃻𒁺𒇲𒀹𒄀𒌑𒑋} in \cite[\href{http://oracc.org/epsd2/P221272.79}{\reverse~2~2}]{P221272},
or {\xsuxfont 𒌋𒇲𒀹𒄀} in \cite[\href{http://oracc.org/epsd2/P020304.20}{\obverse~3~8}]{P020304}.
...
also attested, see, \exempligratia, \cite[\href{http://oracc.org/epsd2/P221346.102}{\reverse~3~6}]{P221346} {\xsuxfont 𒌓𒌋𒇲𒀹𒄰},
\cite[\href{http://oracc.org/epsd2/P221006.19}{\reverse~2~1}]{P221006} {\xsuxfont 𒀉𒌓𒌋𒇲𒀸𒄰}}.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption[]{{\xsuxfont 𒐕𒎙\footnotemark\sevenAshTenu{}𒄀𒊕} ``$501$~m (first) width'' (of a field) in \cite[\href{http://oracc.org/epsd2/P221254.23}{\obverse~3~7}]{P221254} from ED~IIIb Ŋirsu.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont \sevenAshTenu{}𒄀 𒂊 𒆹} ``$21$~m of reed-bed dyke'' (attributed to {\xsuxfont 𒌨𒁮} the farmer) in \cite[\href{http://oracc.org/epsd2/P221266.4}{\obverse~1~1}]{P221266} from ED~IIIb Ŋirsu. Left: Copy from \cite{AllottedelaFuÿe1908}.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption[]{{\xsuxfont\threeŊešTwoC\fourUC 𒃻𒁺\eightAshTenu 𒄀 𒃴\footnotemark{}𒁉 𒌑𒑌} ``$1344$~m, its height $2$~m'' (dimensions of a dyke on the river {\xsuxfont 𒊊𒌉𒁕𒈿𒀀𒀭}) in \cite[\href{http://oracc.org/epsd2/P020303.11}{\obverse~2~2}]{P020303} from ED~IIIb Ŋirsu. Left: Copy from \cite{Marzahn1991}.
  Right: \cite{CDLI} photograph.}
\end{figure}
\footnotetext{This sign contains some hatching ({\xsuxfont 𒃴}×{\xsuxfont 𒆜} or {\xsuxfont 𒃴}×{\xsuxfont 𒊺}).
  A contrast is made in \cite{aBZL} between SUKUD (containing {\xsuxfont 𒊺}) and GALAM
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒐕𒌋\eightAshTenu{}𒄀𒊕𒁲} ``$444$~m equal widths'' (of a field) in \cite[\href{http://oracc.org/epsd2/P221254.5}{\obverse~1~2}]{P221254}.
  Left: Copy from \cite{AllottedelaFuÿe1908}. 
...
\begin{figure}[H]
  ...
  in \cite[\href{http://oracc.org/epsd2/P020182.119}{\reverse~3~5--7}]{P020182} from ED~IIIb Ŋirsu.
  Left: Copy from \cite{VS14}.
  Right: \cite{CDLI} photograph\footnotemark.}\label{figSevenSila3}
\end{figure}
\footnotetext{Where photographs of the
same object from multiple angle are shown,
the third angle projection method is used,
as it puts the views in the direction of reading.
This is indicated in this document by the use of
the symbol defined in \cite[Subclause~5.2]{ISO5456-2:1996}.}
\begin{figure}[H]
  \begin{center}
    \resizebox{.75\textwidth}{!}{
  ...
  in \cite[\href{http://oracc.org/epsd2/P221730.165}{\reverse~2~5--6}]{P221730} from ED~IIIb Ŋirsu.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\sevenAshTenu{}𒄰} ``seventh day'' in \cite[\href{http://oracc.org/epsd2/P220703.208}{\reverse~2~7}]{P220703} from ED~IIIb Ŋirsu.
  Left: Copy from \cite{AllottedelaFuÿe1908}. 
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\sevenAshTenu{}𒉌𒆷} ``seventh day passed'' in \cite[\href{http://oracc.org/epsd2/P221590.14}{\obverse~2~3}]{P221590} from ED~IIIb Nippur.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\eightAshTenu{}𒄰} ``eighth day'' in \cite[\href{http://oracc.org/epsd2/P220703.218}{\reverse~3~1}]{P220703}.
  Left: Copy from \cite{AllottedelaFuÿe1908}. 
  Right: \cite{Louvre} photograph.}\label{figEighthDay}
\end{figure}
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=.75\textwidth]{P452986 r 1 1.png}\rlap{\thirdAngle}
  \end{center}
  \caption{{\xsuxfont 𒌗𒌓\nineAshTenu{}𒉌𒆷} ``ninth day passed'' in \cite[\href{http://oracc.org/epsd2/P452986.4}{\obverse~1~1}]{P452986} (ED~IIIa).
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\nineAshTenu{}𒆛} ``ninth day'' in \cite[\href{http://oracc.org/epsd2/P222129.5}{\obverse~1~2}]{P222129} from ED~IIIa Šuruppag.
...
tablets, as in \cites{P010432}{P010787}{P010896}{P010928}.
...
These numerals are not described in terms of AŠ \emph{tenû}, so we follow
...
{\xsuxfont 𒈗𒍠𒄀𒋛} (Lugalzagesi) mean that these are quite rare; see
...
written {\xsuxfont 𒎙𒇲𒑋} in \cite[\href{http://oracc.org/epsd2/P221483.85}{\reverse~4~12}]{P221483} and
the 19th year of {\xsuxfont 𒂗𒋼𒈨𒈾} written {\xsuxfont 𒎙𒇲𒀹} in \cites[\href{http://oracc.org/epsd2/P221413.56}{\reverse~3~3}]{P221413}[\href{http://oracc.org/epsd2/P222223.16}{\reverse~1~2}]{P222223}.
...
\begin{figure}[H]
  ...
  in \cite[\href{http://oracc.org/epsd2/P020133.15}{\reverse~1~2~\psqq}]{P020133}.
  Left: Copy from \cite{VS14}. 
  Right: \cite{CDLI} photograph.}
\end{figure}
...
\begin{figure}[H]
  ...
  ``Silver payment 5th and 6th (years of Lugalanda)'' in \cite[\href{http://oracc.org/epsd2/P221169.38}{\reverse~3~2}]{P221169},
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont \sevenAshTimesDishTenu} (of {{\xsuxfont 𒌷𒅗𒄀𒈾}}) in \cite[\href{http://oracc.org/epsd2/P222006.10}{\obverse~2~3}]{P222006}.
  Left: Copy from \cite{Никольский1908}. 
  Right: \cite{CDLI} photograph.}
\end{figure}
...
\begin{figure}[H]
  ...
  ``Irikaginak king of Lagaš, year 7'' in \cite[\href{http://oracc.org/epsd2/P386436.11}{\obverse~2~4~\psqq}]{P386436}.
...
\begin{figure}[H]
  ...
  ``carried off, (year) 7 (of Lugalanda)'' in \cite[\href{http://oracc.org/epsd2/P221075.21}{\obverse~3~6}]{P221075},
  dated to the 1st year of {\xsuxfont 𒌷𒅗𒄀𒈾}.
  Left: Copy from \cite{AllottedelaFuÿe1908}. 
...
\begin{figure}[H]
  ...
  ``delivered, (year) 7 (of Lugalanda)'' in \cite[\href{http://oracc.org/epsd2/P221034.27}{\reverse~2~5}]{P221034},
  dated to the 1st year of {\xsuxfont 𒌷𒅗𒄀𒈾}.
  Left: Copy from \cite{AllottedelaFuÿe1908}. 
...
\begin{figure}[H]
  ...
  \cite[\href{http://oracc.org/epsd2/P222224.12}{\obverse~2~4}]{P222224}.
...
\begin{figure}[H]
  ...
  \caption{{\xsuxfont \nineAshTimesDishTenu}
  (of {\xsuxfont 𒌷𒅗𒄀𒈾}) in
  \cite[\href{http://oracc.org/epsd2/P221906.19}{\reverse~2~1}]{P221906}.
  Left: Copy from \cite{Никольский1908}. 
...
as in \cites[\href{http://oracc.org/epsd2/P221075.21}{\obverse~3~6}]{P221075}[\href{http://oracc.org/epsd2/P221034.27}{\reverse~2~5}]{P221034}.
...
{\cite[\href{http://oracc.org/etcsri/Q001133.86}{\reverse~2~10 \psqq}]{P222618}, translation \cite{ETCSRI}}}
...
in \cite{P221534} may preclude treating the former as a stylistic variant of the latter.
Note that
U+\textcsc{12483} {\cuneiformComposite 𒒃} \textcsc{CUNEIFORM SIGN BAD TIMES DISH TENU}
is already encoded as a non-numeric character, and should be used for $1(\text{{\xsuxfont 𒁁}×{\xsuxfont 𒀹}})$
if needed.
These {\xsuxfont 𒁁}×{\xsuxfont 𒀹} numerals are not being proposed at this time.
...
Roozbeh Pournader (\textarabic{روزبه پورنادر}) provided feedback on the text.
...
\includepdf[pages=-2]{tenu-numerals-summary-form.pdf}
