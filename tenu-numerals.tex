...
is already encoded as a non-numeric character, and should be used for {\xsuxfont 𒁁}×$1${\xsuxfont 𒀹}
if needed.
...
is used to for most of the cuneiform text in this document; it incorporates glyphs
