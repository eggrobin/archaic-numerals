...
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=0.375\textwidth]{P221254 o 1 2 copy.png}
  \includegraphics[width=0.375\textwidth]{P221254 o 1 2.png}
  \end{center}
...
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=0.375\textwidth]{P220703 r 2 7 copy.png}
  \includegraphics[width=0.375\textwidth]{P220703 r 2 7.png}
  \end{center}
  \caption{{\xsuxfont 𒌓\sevenAshTenu{}𒄰} ``seventh day'' in \cite[\obverse~2~3]{P220703} from Ŋirsu, dated to the reign of {\xsuxfont 𒈗𒀭𒁕} TODO CHECK.
  Left: Copy from \cite{AllottedelaFuÿe1918}. 
  Right: \cite{LouvreCollections} photograph.}\label{figSevenDays}
\end{figure}
\begin{figure}[H]
  \begin{center}
  \includegraphics[width=0.32\textwidth]{P221590 o 2 3 copy.png}
  \includegraphics[width=0.43\textwidth]{P221590 o 2 3.png}
  \end{center}
  \caption{{\xsuxfont 𒌓\sevenAshTenu{}𒉌𒆷} ``seven days TODO'' in \cite[\obverse~2~3]{P221590} from Nippur.
  Left: Copy from \cite{Westenholz1975}. 
  Right: \cite{CDLI} photograph.}\label{figSevenDays}
\end{figure}
