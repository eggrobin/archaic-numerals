...
\texttt{$n$($\langle\text{name}\rangle$)}.
Since we have no such restriction in Unicode character names, we move the number before the DISH TENU
...
{\xsuxfont 𒌋} for 10~{\xsuxfont 𒌷𒅗𒄀𒈾} in \cite{P222640},
and with subtractive subtraction for
17~{\xsuxfont 𒂗𒋼𒈨𒈾}\footnote{This text mentions {\xsuxfont 𒂗𒇷𒋻𒍣} as temple administrator.
...
19~{\xsuxfont 𒂗𒋼𒈨𒈾} written {\xsuxfont 𒎙𒇲𒑊} in \cites[\reverse~3~3]{P221413}[\reverse~3~3]{P222223}.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒉌𒁺 \sevenAshTimesDishTenu 𒄰}
...
as in \cites[\obverse~3~6]{P239314}[\reverse~2~5]{P239350}.
This distinction is stylistic.
The {\xsuxfont 𒀹} wedges are not stacked until the reign of {\xsuxfont 𒈗𒍠𒄀𒋛};
for regnal years of {\xsuxfont 𒈗𒍠𒄀𒋛} see §\ref{Lugalzagesi}.
...
alternate glyph {\xsuxfont\addfontfeature{StylisticSet=1} 𒋙} for {\xsuxfont 𒋙}, ligatures and kerning of {\xsuxfont 𒇲}).
