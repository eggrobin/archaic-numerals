...
Note that as of this writing, the proposed characters use the private use area in that text,
and the provisionally assigned ones proposed in \cite{L2/24-210R} are unportable until these
are assigned—web fonts are used for both—\confer{}
...
is used to describe slanted signs or parts of signs: thus {\xsuxfont 𒋙} is described as {\xsuxfont 𒁇} \emph{tenû} in \cite[\reverse i 46′]{P365233}\footnote{Note that
...
{\xsuxfont 𒃸} as {\xsuxfont 𒃷} \emph{tenû} in \cites[\reverse ii 47]{P391514}
and as {\xsuxfont 𒂠} \emph{tenû} [\obverse ii 80]{P467315},
...
\exempligratia, 𒃻 being known today as NINDA, GAR (its character name), and NIG₂,
...
\begin{figure}[H]
  ...
  in \cite[\reverse~3~5--7]{P020182} from Ŋirsu, dated to the reign of {\xsuxfont 𒈗𒀭𒁕}.
...
\begin{figure}[H]
  ...
  in \cite[\reverse~2~5--6]{P221730} from Ŋirsu, dated to the reign of {\xsuxfont 𒈗𒀭𒁕}.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\sevenAshTenu{}𒄰} ``seventh day'' in \cite[\reverse~2~7]{P220703} from Ŋirsu, dated to the 3rd year of the reign of {\xsuxfont 𒈗𒀭𒁕}.
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{{\xsuxfont 𒌗𒌓\nineAshTenu{}𒉌𒆷} ``ninth day passed'' in \cite[\obverse~1~1]{P452986}, dated to the ED IIIa period.
  \cite{CDLI} photograph.}\label{figNinthDay}
\end{figure}
\begin{figure}[H]
  \begin{center}
    \resizebox{.75\textwidth}{!}{
  ...
  \end{center}
  \caption{{\xsuxfont 𒌓\nineAshTenu{}𒆛} ``ninth day'' in \cite[\obverse~1~2]{P222129} from Šuruppag, dated to the ED IIIa period.
...
While {\xsuxfont 𒁹} and {\xsuxfont 𒀸} numerals needed to have their
stacking patterns disunified for compatibility with \cite{MZL}, this practice
should not be extended to {\xsuxfont 𒀹} numerals.
...
\cite[71;\pno~74 \withnote~176]{SallabergerSchrakamp2015}.},
...
\begin{figure}[H]
  ...
  Top: Copy from \cite{AllottedelaFuÿe1918}. 
...
\begin{figure}[H]
  ...
  \includegraphics[height=17mm]{P020133 r 1 3 sqq.png}
  }
  \end{center}
  \caption{{\xsuxfont 𒂗𒇷𒋻𒍣} / {\xsuxfont 𒉺𒋼𒋛} / {\xsuxfont 𒉢𒁓𒆷𒆠𒅗} /
  {\xsuxfont \oneAshTimesDishTenu\twoAshTimesDishTenu\threeAshTimesDishTenu\fourAshTimesDishTenu
  𒌨𒌨𒀀 𒂊𒃻} ``Enentarzi was ensik of Lagaš. 1st 2nd 3rd 4th (years) consolidated''
  in \cite[\reverse~1~3~\psqq]{P020133}.
  Left: Copy from \cite{AllottedelaFuÿe1918}. 
  Right: \cite{CDLI} photograph.}
\end{figure}
...
\begin{figure}[H]
  ...
  \end{center}
  \caption{TODO also include one that is clearly 4-3 rather than 2-2-3. {\xsuxfont 𒉌𒁺 \sevenAshTimesDishTenu 𒄰}
  ``delivered, 7th (year of Lugalanda)'' in \cite[\reverse~2~5]{P221034},
  dated to the 1st year of {\xsuxfont 𒌷𒅗𒄀𒈾}.
  Left: Copy from \cite{AllottedelaFuÿe1918}. 
  Right: \cite{CDLI} photograph.}
\end{figure}
...
\begin{figure}[H]
  ...
  (referencing the 8th year of {\xsuxfont 𒂗𒋼𒈨𒈾}) in
  \cite[\reverse~2~4]{P222224}.
  Left: Copy from \cite{CrosThureau-Dangin1910}. 
  Right: \cite{LouvreCollections} photograph.}
\end{figure}
...
Grouping distinctions are not marked in transliteration (and often even lost in copy),
are not contrastive, and should not be represented in encoding.
